            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" name="tanggal_sampel" id="tanggal_sampel"
                        value="{{ old('tanggal_sampel', $kernelCalculation->rounded_time?->toDateString() ?? now()->toDateString()) }}"
                ...
                <div>
                    ...
                    <input type="time" name="rounded_time" id="rounded_time"
                        value="{{ old('rounded_time', $kernelCalculation->rounded_time?->format('H:i') ?? now()->format('H:i')) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm">
                </div>
                <div>
