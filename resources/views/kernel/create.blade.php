                            ...
                            <div class="border rounded-lg p-4 shadow-sm space-y-3 {{ $cardTheme }}" data-kernel-row>
                                    ...
                                    <div>
                                        ...
                                        @if(!empty($operatorOptions))
                                            <select name="rows[{{ $kode }}][operator]"
                                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error("rows.$kode.operator") border-red-400 bg-red-50 @enderror">
                                        ...
                                        @else
                                            <input type="text" name="rows[{{ $kode }}][operator]"
                                                ...
                                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error("rows.$kode.operator") border-red-400 bg-red-50 @enderror">
                                        @endif
                                        @error("rows.$kode.operator")<p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="space-y-1 {{ old("rows.$kode.pengulangan") ? '' : 'hidden' }}" data-remarks-wrapper>
                                    ...
                                    <textarea name="rows[{{ $kode }}][remarks]" rows="3"
                                        ...
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old("rows.$kode.remarks") }}</textarea>
                                </div>
