                        ...
                        @foreach ($kernelQwtRows as $row)
                            ...
                            <tr class="hover:bg-blue-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->sampel_setelah_kuarter ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_nut_utuh ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_nut_pecah ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_kernel_utuh ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_kernel_pecah ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_cangkang ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_batu ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_fiber ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->berat_broken_nut ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->total_berat_nut ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-center">
                                    <span
                                ...
                                <td
                                    ...
                                    @if($bnTnLimitValue !== null)
                                        ...
                                        {{ number_format($bnTnLimitValue, 2) }}%
                                    @else
                                        -
                                    @endif
                                </td>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->ampere_screw ?? 0), 2) }}
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->tekanan_hydraulic ?? 0), 2) }}
                                </td>
                                
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    {{ number_format((float) ($row->kecepatan_screw ?? 0), 2) }}
                                </td>
                                @canany(['edit kernel losses', 'delete kernel losses'])
                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            ...
                                            @can('delete kernel losses')
                                                <form action="{{ route('kernel.qwt.destroy', $row->id) }}" method="POST"
